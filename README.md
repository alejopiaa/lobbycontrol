...
LobbyTracker es una solución diseñada para organismos públicos e instituciones que requieren procesar, auditar y explorar registros de audiencias de lobby. Permite cargar planillas de datos externas, consolidarlas en una base de datos local ligera y segura, y ofrecer una interfaz intuitiva con análisis estadísticos en tiempo real, búsqueda avanzada y exportación de reportes.
...
*   **SQLite optimizado con WAL:** Activación de *Write-Ahead Logging* para habilitar lecturas y escrituras simultáneas y fluidas.
...
1.  **Clonar el repositorio:**
    ```bash
    git clone https://github.com/alejopiaa/lobbytracker.git
    cd lobbytracker
    ```
